...
OBJS = prog5.o init_mall.o decide.o small.o eventList.o tile.o shopper.o robot.o globalItem.o localItem.o movement.o 
...
prog5.o : globals.h externals.h prog5.cpp 
	$(CC) $(CFLAGS) prog5.cpp
